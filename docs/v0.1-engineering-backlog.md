# v0.1 Engineering Backlog - Architecture Decision Record Generator

## 1. Release Objective

- Product Type: CLI
- Primary Command/API: adr-gen
- v0.1 Goal: Create ADR drafts from PR/repository change context and rationale templates.
...
PR metadata, changed files, optional architecture rules

### Outputs

new ADR markdown file, summary json
...
- Core Acceptance Test: Given PR fixture, command generates ADR file with decision, context, options, consequences sections populated.
